...
const projects = [
  ...
  },
  {
    ...
    stack: ["Prometheus", "Grafana", "Loki", "Headlamp", "Kubernetes Dashboard"],
    rot: 2,
  },
  {
  ...
  return (
    <section id="projects" className="relative py-32 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-[1400px] px-6 lg:px-12">
        <SectionHeader index="04" kicker="// SHOWCASE" title="PROJECTS SHOWCASE." />
            ...
            >
              ...
              <div className="relative bg-ink jagged-clip overflow-hidden">
                ...
                <div className="relative h-48 bg-gradient-to-br from-electric/40 via-ink to-ink overflow-hidden">
                  ...
                  <div className="absolute inset-4 bg-ink/80 border border-electric/40 backdrop-blur-sm overflow-hidden"
                  ...
                  >
                    ...
                    <div className="p-4 space-y-2">
                      <div className="h-2 w-3/4 bg-electric/40" />
                      <div className="h-2 w-1/2 bg-electric/25" />
                      <div className="h-2 w-2/3 bg-electric/25" />
                      <div className="grid grid-cols-3 gap-1.5 pt-2">
                        <div className="h-6 bg-electric/20" />
                        <div className="h-6 bg-electric/35" />
                        <div className="h-6 bg-electric/20" />
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    <StarBurst className="w-16 h-16 opacity-60" color="var(--electric)" />
                  </motion.div>
                </div>
                ...
                <div className="p-6 border-t-4 border-electric">
                  <div className="flex items-start justify-between gap-4 mb-3">
                    <div>
                      ...
                      <p className="font-marker text-electric text-sm tracking-widest">{p.type}</p>
                    </div>
                  ...
                  <p className="text-sm text-bone/75 leading-relaxed mb-4">{p.desc}</p>
                  <div className="flex flex-wrap gap-2">
                    {p.stack.map((s, si) => (
                      <Ribbon key={s} color={si % 2 === 0 ? "electric" : "bone"} skew={-8}>
                        <span className="font-mono text-[10px] tracking-wider">{s}</span>
                      </Ribbon>
                    ))}
                  </div>
                </div>
